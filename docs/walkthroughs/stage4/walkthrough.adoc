...
. Simulate a Discord payload
+
Let's modify the code to simulate the JSON payload Discord expects. Replace the body with the following:
+
```yaml
      - setBody:
...
. Invoke Discord
+
Modify the code to call Discord's API to post a message. +
