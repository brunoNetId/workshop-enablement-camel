...
+
image::images/gitter-dev-token.png[align="left", width=50%,border-color="green", border-width="3"]
+
...
image::images/gitter-dev-new-app.png[align="left", width=60%,border-color="green", border-width="3"]
--
...
+
image::images/gitter-dev-new-app-approve.png[align="left", width=50%,border-color="green", border-width="3"]
+
