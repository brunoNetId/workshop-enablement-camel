...
This first stage (part-1) is all about completing our first integration flow using a Kamelet Binding.
...
[type=verification]
Did you complete Gitter's onboarding successfully?
...
// * link:../stage1-5-kubernetes/walkthrough.adoc[Kubernetes persona]
...
// .Camel
// ****
// * link:https://camel.apache.org/[Test taskResource, window="_blank"]
// ****
